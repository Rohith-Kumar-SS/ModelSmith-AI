...
# Storage root for images, models, state and audit reports.
# Override with the MODELSMITH_STORAGE environment variable.
STORAGE_ROOT = os.environ.get(
    "MODELSMITH_STORAGE",
    os.path.join(os.path.expanduser("~"), ".modelsmith", "storage"),
)
